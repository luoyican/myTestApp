package com.rfchina.internet.wheelviewsdk.datepicker.widget;
...
import com.rfchina.internet.wheelviewsdk.datepicker.widget.adapter.WheelViewAdapter;
...
public class WheelView extends View {
     ...
     */
    private int[] SHADOWS_COLORS = new int[]{0xe8ffffff,
            0xb3ffffff, 0x00e8e8e8};
