...
/**
 * Created by luoyican on 2017/7/5.
 */

public class MinionsDraw extends View{
    ...
    public MinionsDraw(Context context) {
        super(context);
    }

    public MinionsDraw(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
